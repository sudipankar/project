                ...
                <div class="row">
                      ...
                      <div class="card">
                          ...
                          <div class="card-body card-block">
                                <div class="row form-group">
                                  ...
                                  <div class="col-12 col-md-8"><input type="text" id="fullname" name="fullname" placeholder="Name" class="form-control" value="{{ $user->name }}"></div>
                                </div>
                                  <div class="row form-group">
                                  ...
                                  <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-8"><input type="text" id="address1" name="address1" placeholder="Address Line #1" class="form-control" value="{{ $user->address1 }}"></div>
                                  </div>
                                  <div class="row form-group">
                                    <div class="col col-md-4"><label for="text-input" class=" form-control-label">Address Line 2</label></div>
                                    <div class="col-12 col-md-8"><input type="text" id="address2" name="address2" placeholder="Address Line #2" class="form-control" value="{{ $user->address2 }}"></div>
                                  </div>
                                  <div class="row form-group">
                                    <div class="col col-md-4"><label for="text-input" class=" form-control-label">City</label></div>
                                    <div class="col-12 col-md-8"><input type="text" id="city" name="city" placeholder="City" class="form-control" value="{{ $user->city }}"></div>
                                  </div>
                                  <div class="row form-group">
                                    <div class="col col-md-4"><label for="text-input" class=" form-control-label">State</label></div>
                                    <div class="col-12 col-md-8"><input type="text" id="state" name="state" placeholder="State" class="form-control" value="{{ $user->state }}"></div>
                                  </div>
                                  <div class="row form-group">
                  ...
                  <div class="col-xs-6 col-sm-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                          @if($user->image)
                            <img src="{{ asset('/public/images/user_images/'. $user->image) }}" width="200px" height="200px" />
                          @else
                            <img src="{{ asset('/public/images/user_images/default.jpg') }}" width="200px" height="200px" />
                          @endif
                    </div>
                </div>
                      <div class="card">
