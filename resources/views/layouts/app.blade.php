...
<head>
  ...
  <!-- jQuery -->
  <script type="text/javascript" src="{{ asset('/public/vendors/jquery/dist/jquery.min.js')  }}"></script>
    <!-- CSRF Token -->
    ...
    <!-- Scripts -->
    <script src="{{ asset('/publicjs/app.js') }}" defer></script>
    ...
    <!--<script src="{{ asset('/public/vendors/pnotify/dist/pnotify.css') }}"></script>-->
    <!--<script src="{{ asset('/public/vendors/pnotify/dist/pnotify.buttons.css') }}"></script>-->
    <!--<script src="{{ asset('/public/vendors/pnotify/dist/pnotify.nonblock.css') }}"></script>-->
          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                @if(Auth::user()->image)
                    <img src="{{ asset('/public/images/user_images/'. Auth::user()->image) }}" alt="{{ Auth::user()->name }}" class="img-circle profile_img">
                @else
                    <img src="{{ asset('/public/images/user_images/default.jpg') }}" alt="{{ Auth::user()->name }}" class="img-circle profile_img">
                @endif
              </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <!--  </ul>-->
                  <!--</li>-->
                  <li><a href="{{ route('users') }}"><i class="fa fa-user"></i> Users List</a></li>
                  <li><a href="{{ route('professions') }}"><i class="fa fa-bars"></i> Professions</a></li>
                  <li><a href="{{ route('questionnaires') }}"><i class="fa fa-edit"></i>Quesionnaires</a></li>
                  <li><a href="{{ route('ebooks') }}"><i class="fa fa-book"></i> Ebooks</a></li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    @if(Auth::user()->image)
                        <img src="{{ asset('/public/images/user_images/'. Auth::user()->image) }}" alt="{{ Auth::user()->name }}">
                    @else
                        <img src="{{ asset('/public/images/user_images/default.jpg') }}" alt="{{ Auth::user()->name }}">
                    @endif
                    {{ Auth::user()->name }}
