					 ...
					 <input type="hidden" name="ebook_id" value="<?php echo $ebook->id;?>">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="title" name="title" required="required" class="form-control col-md-12 col-xs-12" value="{{ $ebook ? $ebook->ebook_title : '' }}">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea class="resizable_textarea form-control" name="description" placeholder="Ebook Description">{{ $ebook ? $ebook->ebook_desc : '' }}</textarea>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="price" name="price"  required="required" class="form-control col-md-12 col-xs-12" value="{{ $ebook ? $ebook->price : '' }}">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select id="profession" class="form-control col-md-12 col-xs-12" name="profession">
                            ...
                            @foreach($professions as $index => $profession)
                              <option value="{{ $profession->id }}" {{ ($ebook && $ebook->professions_id == $profession->id) ? "selected" : "" }}>{{ $profession->cat_name }}</option>
                            @endforeach
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <a href="{{ route('ebooks') }}" class="btn btn-primary">Back</a>
