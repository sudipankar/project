                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
						  ...
						  <?php if(isset($ind_profession)){?>
                            <form id="user_detail_form" class="form-horizontal" method="post" action="<?php echo e(route('add_prof')); ?>">
						  <?php }else{?>
						    <form id="user_detail_form" class="form-horizontal" method="post" action="<?php echo e(route('edit_prof')); ?>">
						  <?php } ?>	
                                <?php echo csrf_field(); ?>
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <?php $__currentLoopData = $professions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $profession): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
                            <td><?php echo e($profession->cat_name); ?></td>
                            <td>
                              <input type="checkbox" class="js-switch" <?php echo e(($profession->status) ? 'checked' : ''); ?> />
                              <input type="hidden" name="prof_id" id="prof_id" value="<?php echo e($profession->id); ?>" />
                            </td>
                            <td>
                              <a href="<?php echo e($site_url.'/professions/'.$profession->id); ?>/edit" class="btn btn-xs btn-default"><i class="fa fa-edit"></i>Edit</a>
                              <a href="<?php echo e($site_url.'/professions/'.$profession->id); ?>/delete" class="btn btn-xs btn-default"><i class="fa fa-close"></i>Delete</a>
                            </td>
                          </tr>
