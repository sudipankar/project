...
<body data-spy="scroll" data-target=".navbar-fixed-top">
				...
				<div class="navbar-collapse collapse" id="myNavbar">
					<ul class="nav navbar-nav navbar-right">
						...
						<?php if(auth()->guard()->check()): ?>
							...
							<li><a class="" href="<?php echo e(route('dashboard')); ?>">DASHBOARD</a></li>
						<?php endif; ?>
					</ul>
				</div>
	...
	<div id="login-form" class="lightbox-form-container zoom-anim-dialog mfp-hide">
		<div class="row">
			...
			<div class="col-md-12">
				<h2>Login Form</h2>
				<form id="login_form" method="post" action="<?php echo e(route('userlogin')); ?>" data-toggle="validator">
					<?php echo csrf_field(); ?>
	...
	<!-- Register form -->
	<div id="register-form" method="post" action="<?php echo e(route('register_user')); ?>" class="lightbox-form-container zoom-anim-dialog mfp-hide">
		<div class="row">
			<button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
			<div class="col-md-12">
				<h2>Register Form</h2>
				<form id="register_form" action="<?php echo e(route('register_user')); ?>" method="post" data-toggle="validator">
					<?php echo csrf_field(); ?>
					<p><strong>Email *</strong></p>
					<div class="form-group">
						<input type="text" class="form-control-input" id="email" name="email" placeholder="Email" required>
...
$(document).ready(function() {
	...
	$(document).on("submit", "#payment_form", function(e) {
	    ...
	    form_data.push({name: '_token', value: '<?php echo e(csrf_token()); ?>'});
	    ...
	    $.ajax({
	        ...
	        success: function(response) {
	            if(response['status']) {
	                ...
	                var ebook_link = '<?php echo e(asset("/ebook_files/")); ?>';
