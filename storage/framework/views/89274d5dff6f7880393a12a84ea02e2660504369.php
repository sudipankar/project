            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form id="add_ques_form" method="post" action="<?php echo e(route('add_question')); ?>" data-parsley-validate class="form-horizontal form-label-left">
                    <?php echo csrf_field(); ?>
                    <?php if($option_id): ?>
                      <input type="hidden" name="option_id" value="<?php echo e($option_id); ?>" />
                    <?php endif; ?>
                    <input type="hidden" name="cat_id" value="<?php echo e($professions[0]->id); ?>" />
                    <div class="row">
                      <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <br />
                              ...
                              <div class="form-group">
                                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                  <a class="btn btn-primary" href="<?php echo e(route('questionnaires')); ?>">Back</a>
